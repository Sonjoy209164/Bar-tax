...
class Settings(BaseSettings):
    ...
    generator_provider: str = Field(default="mock", alias="GENERATOR_PROVIDER")
    generator_model_name: str = Field(default="mock-grounded-generator", alias="GENERATOR_MODEL_NAME")
