...
class ProductOntology:
    ...
    PRODUCT_SYNONYMS: dict[str, tuple[str, ...]] = {
        ...
        "foundation": ("foundation", "compact", "base makeup"),
        ...
        "security_camera": ("security camera", "indoor cam", "indoor camera", "smart camera", "camera"),
    ...
    PRODUCT_FAMILIES: dict[str, str] = {
        ...
        "dress": "fashion_womenswear",
        "tunic": "fashion_womenswear",
        ...
        "kajal": "beauty_cosmetics",
        "sunscreen": "beauty_skincare",
        "face_wash": "beauty_skincare",
    ...
    CROSS_SELL_COMPATIBILITY: dict[str, set[str]] = {
        ...
        "panjabi": {"shawl", "bag", "shoes", "perfume", "watch"},
        "kurti": {"dupatta", "jewelry", "bag", "shoes", "perfume"},
        "dress": {"jewelry", "bag", "shoes", "perfume", "watch"},
        "tunic": {"dupatta", "jewelry", "bag", "shoes", "perfume"},
        "salwar_kameez": {"dupatta", "jewelry", "bag", "shoes", "perfume"},
        ...
        "perfume": {"panjabi", "shirt", "saree", "watch"},
        "watch": {"shirt", "panjabi", "perfume"},
        "laptop": {
            "charger",
            "cleaning_kit",
            "dock",
