...
_SYMBOL_MODULES = {
    ...
    "PROMPT_STRATEGIES": "app.reasoning.prompt_strategies",
    "QueryPlanStep": "app.reasoning.state",
    "REFUSAL_TEXT": "app.reasoning.nli_guardrail",
    "REASONING_TRACE_MODES": "app.reasoning.prompt_strategies",
    ...
    "apply_prompt_strategy": "app.reasoning.prompt_strategies",
    "build_agent_evidence": "app.reasoning.evidence_builder",
    "build_agent_graph": "app.reasoning.agent_graph",
    "build_safe_reasoning_trace": "app.reasoning.prompt_strategies",
    "normalize_prompt_strategy": "app.reasoning.prompt_strategies",
    "normalize_reasoning_trace_mode": "app.reasoning.prompt_strategies",
